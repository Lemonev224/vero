  ...
  return (
    <div className="text-gray-900 transition-colors duration-300 bg-white">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 sm:px-6 pt-24 sm:pt-28 pb-0" id="hero">
        {/* Hero Gradient Image */}
        <div 
          className="absolute w-full h-[500px] sm:h-[600px] md:h-[700px] left-0 top-[45%] sm:top-[50%] transform -translate-y-1/2 z-0 pointer-events-none"
        >
          <img 
...
>
            <div className="relative w-full h-full">
              ...
              {/* Gradient Fade */}
              <div 
                className="absolute top-[55%] left-0 right-0 bottom-0 pointer-events-none z-20"
                style={{
                  background:
